...
var Delayed = function Delayed() {this.id = null};
Delayed.prototype.set = function set (ms, f) {
...
Line.prototype.lineNo = function lineNo$1 () { return lineNo(this) };
eventMixin(Line)
...
LeafChunk.prototype.chunkSize = function chunkSize () { return this.lines.length };

// Remove the n lines at offset 'at'.
LeafChunk.prototype.removeInner = function removeInner (at, n) {
    var this$1 = this;
...
LeafChunk.prototype.collapse = function collapse (lines) {
  lines.push.apply(lines, this.lines)
};

// Insert the given array of lines at offset 'at', count them as
// having the given height.
LeafChunk.prototype.insertInner = function insertInner (at, lines, height) {
    var this$1 = this;
...
LeafChunk.prototype.iterN = function iterN (at, n, op) {
    var this$1 = this;
...
BranchChunk.prototype.chunkSize = function chunkSize () { return this.size };

BranchChunk.prototype.removeInner = function removeInner (at, n) {
    var this$1 = this;
...
BranchChunk.prototype.collapse = function collapse (lines) {
    var this$1 = this;

  for (var i = 0; i < this.children.length; ++i) { this$1.children[i].collapse(lines) }
};

BranchChunk.prototype.insertInner = function insertInner (at, lines, height) {
    var this$1 = this;
...
BranchChunk.prototype.maybeSpill = function maybeSpill () {
...
BranchChunk.prototype.iterN = function iterN (at, n, op) {
    var this$1 = this;
...
// Clear the marker.
TextMarker.prototype.clear = function clear () {
    var this$1 = this;
...
TextMarker.prototype.find = function find (side, lineObj) {
    var this$1 = this;
...
TextMarker.prototype.changed = function changed () {
    var this$1 = this;
...
TextMarker.prototype.attachLine = function attachLine (line) {
...
TextMarker.prototype.detachLine = function detachLine (line) {
...
SharedTextMarker.prototype.clear = function clear () {
    var this$1 = this;
...
SharedTextMarker.prototype.find = function find (side, lineObj) {
