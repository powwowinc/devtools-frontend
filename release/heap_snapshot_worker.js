...
static fromMimeType(mimeType){var contentTypeAndTopLevelType=mimeType.match(/(\w*)\/\w*/);if(!contentTypeAndTopLevelType)
return Common.resourceTypes.Other;var resourceType=Common.ResourceType._resourceTypeByMimeType.get(contentTypeAndTopLevelType[0]);if(resourceType)
return resourceType;resourceType=Common.ResourceType._resourceTypeByMimeType.get(contentTypeAndTopLevelType[1]);if(resourceType)
return resourceType;return Common.resourceTypes.Other;}
...
setting.setTitle(descriptor['title']);setting._extension=extension;this._moduleSettings.set(settingName,setting);}
